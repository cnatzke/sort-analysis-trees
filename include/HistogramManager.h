...
// Data vecors
std::vector<float> crystal_energy_vec;     // vector which contains the energy values
std::vector<float> addback_energy_vec;     // vector which contains the energy values
std::vector<TVector3> crystal_pos_vec;     // vector which contains the position values
std::vector<TVector3> addback_pos_vec;     // vector which contains the position values
...
public:
    ...
    void SetMultiplicityFilter(bool val) {_multiplicity_filter = val;};
    bool GetMultiplicityFilter() {return _multiplicity_filter;};
