...
private:
    ...
    std::vector<float> angular_bin_vec;
    std::vector<float> compton_limit_vec_ftb;
    std::vector<float> compton_limit_vec_btf;
    ...
    std::vector<int> detector_vec; // vector containing detector ids
